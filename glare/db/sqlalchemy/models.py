...
class ArtifactDependecy(BASE, ArtifactBase):
    __tablename__ = 'glare_dependencies'
    ...
    artifact_source = Column(String(36), ForeignKey('glare_artifacts.id'),
                             primary_key=True)
    artifact_dest = Column(String(36), ForeignKey('glare_artifacts.id'),
                           primary_key=True)

def register_models(engine):
    """Create database tables for all models with the given engine."""
    models = (Artifact, ArtifactTag, ArtifactProperty, ArtifactBlob,
              ArtifactLock, ArtifactQuota, ArtifactDependecy)
    for model in models:
...
def unregister_models(engine):
    ...
    models = (ArtifactDependecy, ArtifactQuota, ArtifactLock, ArtifactBlob, ArtifactProperty,
