...
class DynamicLoggingListener(base.Listener):
    """Listener that logs notifications it receives and updates glare db info.
    ...
    * ``states.REVERT_FAILURE``
    ...
    def __init__(self, engine, flow_id,
    ...
    def _flow_receiver(self, state, details):
        ...
        flow.update_flow(flow_id=self.flow_id, status=state)
