...
class Generator(command.Lister):
    """
    This class is used to Generates Custom artifact-type. It uses "artifact_type_template.txt" to create artifact type file.
    ...
    Output: Provides response object contains status and path in case of success and status and Message in case of failure.
