...
artifact_policy_rules = [
    ...
    policy.RuleDefault("artifact:set_external_location", "rule:admin_or_owner",
                       "Policy to set external location for artifact"),
    policy.RuleDefault("artifact:set_internal_location",
                       "rule:context_is_admin",
                       "Policy to set internal location for artifact"),
