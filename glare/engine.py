...
class Engine(object):
    ...
    def delete(self, context, type_name, artifact_id):
        ...
        if hard_dependency.get_hard_dependencies_children(artifact_id):
            raise exception.Forbidden
    ...
    def get_hard_dependencies_children(self, context, artifact_id):
        ...
        return hard_dependency.get_hard_dependencies_children(artifact_id)
    ...
    def set_hard_dependencies(self, context, source_id, target_id):
        ...
        src_dep_children_graph = hard_dependency.get_hard_dependencies_children(source_id)
        # if we have target_id artifact in src_dep_children_graph, it means
        # that creating this H.D will cause a cycle


        dependencies = src_dep_children_graph["graph"]["dependencies"]
    ...
    def delete_hard_dependencies(self, context, source_id, target_id):
        ...
        src_dep_graph_dict = hard_dependency.get_hard_dependencies(source_id)
