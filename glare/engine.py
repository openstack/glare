...
class Engine(object):
    ...
    def _get_schemas(self, reg):
        if getattr(self, 'schemas', None):
            pass
        else:
            schemas = {}
    ...
    def list_type_schemas(self, context):
        ...
        return self._get_schemas(registry.ArtifactRegistry)

    def show_type_schema(self, context, type_name):
        policy.authorize("artifact:type_list", {}, context)
        schemas = self._get_schemas(registry.ArtifactRegistry)
