...
def create_quota(project_id, quota_name, quota_value, type_name=None):
    session = api.get_session()
    return api.create_quota(
        project_id, quota_name, quota_value, session, type_name)


def update_quota(project_id, quota_id, quota_value):
    session = api.get_session()
    return api.update_quota(project_id, quota_id, quota_value, session)
