...
class TestArtifact(functional.FunctionalTest):
    ...
    def test_latest_filter(self):
        ...
        group1_list = [self.create_artifact(
            {'name': 'group1',
        ...
        group2_versions = ['1',  '1000.0.1-beta', '9.0', '99.0', '1000.0.0']
        group2_list = [self.create_artifact(
            {'name': 'group2',
        ...
        url = '/sample_artifact?latest&sort=name:asc'
        res = self.get(url=url, status=200)['sample_artifact']
        self.assertEqual(2, len(res))
        self.assertEqual('20.0.0', res[0]['version'])
        self.assertEqual('1000.0.1-beta', res[1]['version'])

        url = '/sample_artifact?latest&name=group1'
        res = self.get(url=url, status=200)['sample_artifact']
