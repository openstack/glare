...
class TestArtifact(functional.FunctionalTest):
    ...
    def setUp(self):
        ...
        self.glare_server.enabled_artifact_types = (
            'sample_artifact, glance_image, tosca_template, '
            'heat_template, heat_environment')
