...
class TestArtifactList(base.BaseTestArtifactAPI):
    ...
    def test_list_simple_fields(self):
        ...
        # List all artifacts
        res = self.controller.list(self.req, 'sample_artifact', None)
        ...
        res = self.controller.list(anon_req, 'sample_artifact', None)
    ...
    def test_filter_by_tags(self):
        ...
        # Tags are filtered without operator
        filters = [('tags', 'eq:tag1')]
        self.assertRaises(
    ...
    def test_list_and_sort_negative(self):
        ...
        # sort by more than 1 custom field (deprecated with mysql backend)
