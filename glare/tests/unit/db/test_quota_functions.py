...
class TestQuotaFunctions(base.BaseTestArtifactAPI):
    ...
    def test_quota_crud_db_operations(self):
        ...
        q1 = api.create_quota(project_id='project1',
                              name='max_uploaded_data',
                              value=1000, session=self.session)
        ...
        self.assertRaises(
            ...
            project_id='project1', name='max_artifact_number',
            value=10, session=self.session)
