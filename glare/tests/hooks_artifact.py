...
class HookChecker(base.BaseArtifact):
    fields = {
        ...
        'forbid_delete': Field(fields.FlexibleBooleanField,
                               default=False, mutable=True),
        # TODO(mfedosin): this should be configured with CONF file.
        # Remove it when configuration per artifact type is merged
        'inmemory_processing': Field(fields.FlexibleBooleanField,
                                     default=False, mutable=True)
    }
