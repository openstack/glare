...
class Field(object):
    def __init__(self, field_class, mutable=False, required_on_activate=True,
        ...
        *sortable - boolean value indicating if there is a possibility to sort
         by this fields's values. (Default: False) Only fields of 4 primitive
         types may be sortable: integer, string, float and boolean.
        ...
        *validators - a list of objects. When user sets a value to the field
         ...
         and raises ValueError if at least one of the requirements
         is not satisfied.
