...
# --version 1.1 \
# --fields my_str:String,my_int:Integer,my_dict_of_ints:IntegerDict,my_list_of_links:LinkList \
...
class {class_name}(base_artifact.BaseArtifact):
    ...
    #
    # * default - a default value for the field may be specified (Default: None)
    #
    # * validators - a list of objects. When user sets a value to the field with
    #   additional validators Glare checks them before setting the value and
    #   raises ValueError if at least one of the requirements is not satisfied.
